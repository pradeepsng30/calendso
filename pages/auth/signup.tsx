...
export default function Signup(props: InferGetServerSidePropsType<typeof getServerSideProps>) {
  ...
  const signUp = (e) => {
    ...
    fetch("/api/auth/signup", {
      ...
      .then(handleErrors)
      .then(() => signIn("PickMyMentor", { callbackUrl: (router.query.callbackUrl || "") as string }))
      .catch((err) => {
        setHasErrors(true);
            ...
            <div>
              ...
              <div className="mb-2">
                ...
                <input
                  ...
                  value={props.email}
                  className="bg-gray-100 mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
              <div className="mb-2">
